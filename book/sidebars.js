const sidebars = {
  tutorialSidebar: [
...

    {
      ...
      items: [
        'vla-systems/intro',
        'vla-systems/vision-language-models',
        'vla-systems/vla-architecture',
        'vla-systems/llm-planning',
        'vla-systems/prompting-strategies',
        'vla-systems/action-grounding',
        'vla-systems/embodied-reasoning',
        'vla-systems/end-to-end-pipeline',
